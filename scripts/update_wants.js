...
// Fallback & seed schema structure
...
async function run() {
  console.log('Fetching latest weekly wants...');
  
  // Saves the output to wants.json
  const data = {
    updatedAt: new Date().toISOString(),
    villagers: FALLBACK_VILLAGERS
  };

  fs.writeFileSync('wants.json', JSON.stringify(data, null, 2));
  console.log('wants.json successfully generated.');
}
